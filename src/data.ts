...
// Collapse consecutive duplicate path components: art/critters/critters → art_critters
function lstToJsonName(lst: string): string {
...
export function getLstJson(lst: string, id: number): any {
