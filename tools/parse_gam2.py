# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 01:05:36 2026
...
def find_case_insensitive(directory: str, filename: str) -> str | None:
    """Find a file in a directory with case-insensitive matching (non-recursive)."""
...
def find_recursive(root: str, filename: str) -> str | None:
    """Recursively search for a file (case-insensitive) under root directory."""
    target = filename.lower()
...
def find_dir_recursive(root: str, dirname: str) -> str | None:
    """Recursively search for a directory (case-insensitive) under root."""
...
def main():
    ...
    vault13_path = find_recursive(data_dir, "VAULT13.GAM")
    if vault13_path:
    ...
    maps_dir = find_dir_recursive(data_dir, "maps")
