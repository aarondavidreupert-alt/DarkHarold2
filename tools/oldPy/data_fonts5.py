# -*- coding: utf-8 -*-
"""
Created on Sun Apr 19 22:33:25 2026
...
# AAF pixels are 0–9 (brightness index).
# Palette reverse-engineered from jsFO (loader_aaf.py) — these are the actual
# Fallout brightness steps, not a formula. Index 4 == index 3 (intentional).
AAF_PALETTE = [0, 30, 66, 116, 116, 169, 219, 255, 255, 255]
        ...
        if s['width'] > 0 and s['height'] > 0:
            ...
            for py in range(s['height']):
                for px_ in range(s['width']):
                    ...
                    if v > 0:
                        brightness = AAF_PALETTE[v] / 255.0
                        pix[px_, py] = (
