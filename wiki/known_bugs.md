...
| ID | Description | File(s) | CE Reference | Sev | Status |
|----|-------------|---------|--------------|-----|--------|
| IW1 | **Indicator bar wired.** FIXED 2026-06-04, updated 2026-06-11 — `updateIndicatorBar()` shows all 5 CE badges in correct order (ADDICT/SNEAK/LEVEL/POISONED/RADIATED); LEVEL badge when `skillPoints > 0`; POISONED threshold ≥1; RADIATED threshold corrected to ≥65 (was 150); bad badges red, good badges green. CE ref: `interface.cc indicatorBarRefresh`. | `src/ui_hud.ts` | `interface.cc indicatorBarInit()` | major | fixed |
