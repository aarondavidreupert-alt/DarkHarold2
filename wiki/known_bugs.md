...
| S12 | `proto_data` (critters) | `scripting.ts:1245` | Item fields: 12 data_member cases handled. Critter: cases 0/3/4/5/6/7/8/10/11 handled (PID/FID/light/flags/SID/head/body). Missing: case 1 (name), 2 (description), 9 (data ptr → SPECIAL stats block). Wiki entry was stale. | major | partial |
