...
> **Last audited: 2026-06-04** — June 4 roadmap sprint (27 closures): S3/STAT_AGE, S5/critter_add_trait PERK, S11/anim reverse, S2/metarule3 107, C8/wander radius, C13/stay_close, P3/companion follow, P4/closed-unlocked doors, P5/MULTIHEX neighbors, P6/shoot-blocking, P7/scenery LoS, LE1/carry weight, LE4/weapon stack identity, LE6/inventory pickup_p_proc, LE7/item_caps_total live sum, LE9/container use_p_proc, LE11/multi-pile money, IW1/indicator bar, IW2/attack button grey, IW4/HUD bar hide, IW7/AP fade, CI4/doAlwaysRun default, T1/combat-turn explosions, AC3/CRITTER_SPECIAL_DEATH, RD12/camera clamp, FA4/combat walk-speed; verified-fixed: U1/prefs, U2/volume, AC2/death by dmg type, AC5/AI taunts. Older audit history:
