...
| GTC5 | **No midnight queue event.** PARTIAL 2026-06-02 — `main.ts` didTick block now detects day-number changes and logs "QUEUE PROCESS: Midnight!". `objectUnjamAll()` deferred pending IU3; `_scriptsCheckGameEvents()` (ARTIMER movies) not yet implemented; radiation deferred. CE ref: `scripts.cc:405 gameTimeEventProcess`. | `main.ts:1035` | `scripts.cc:405 gameTimeEventProcess` | minor | partial |
