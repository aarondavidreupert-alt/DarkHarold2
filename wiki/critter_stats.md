...
> DH2 impl: `src/object/Critter.ts`, `src/object/Obj.ts`, `src/critter/Weapon.ts`, `src/critter/lifecycle.ts`, `src/pro.ts`, `src/char.ts`, `src/combat.ts` (barrel; `src/combat/*.ts`), `src/scripting.ts`, `src/vm_bridge.ts`
