...
| File | Summary |
|------|---------|
| [rendering.md](rendering.md) | CE software render pipeline vs DH2's WebGL 2.0 pipeline: tile draw order, object Z-sort algorithm, screen-position math, and the authoritative catalogue of all 16 known deviations (RD06–RD16) including missing roof clipping, object sort approximation, and absent palette effects. |
